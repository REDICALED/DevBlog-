...
export const PostSuggest = (props:any) => {
    ...
    return (
      <div >
      <a href={`/post/${props.data.uuid}`} className={` ${props.data ? `block` : `hidden`} flex flex-col items-center border-2 border-[var(--text-color)]  rounded-lg shadow md:flex-row hover:opacity-75 transition-opacity`}>
