...
export const PostSuggest = (props:any) => {
    ...
    return (
      <div className="">
      <a href={`/post/${props.data.uuid}`} className={` ${props.data ? `block` : `hidden`} flex flex-col items-center border-2 border-[var(--text-color)] transition-opacity rounded-lg shadow lg:flex-row  hover:opacity-75`}>
